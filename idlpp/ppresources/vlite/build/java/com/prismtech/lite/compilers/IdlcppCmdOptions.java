...
public class IdlcppCmdOptions extends CmdOptions
{
  ...
  public void optHelp (java.io.PrintStream io)
  {
    ...
    io.println ("   -idlpp           The idlpp executable (REQUIRED)");
    io.println ("   -templates       Templates directory (REQUIRED)");
  }
  ...
  public boolean process (String arg1, String arg2) throws CmdException
  {
    ...
    else if (arg1.equals ("-idlpp"))
    {
      if (arg2 == null || arg2.charAt (0) == '-')
      {
        System.err.println
          (name + ": idlpp executable expected following -idlpp option");
        throw new CmdException (1);
      }
      idlpp = arg2;
      result = true;
    }
    else if (arg1.equals ("-templates"))
    {
      if (arg2 == null || arg2.charAt (0) == '-')
      {
        System.err.println
          (name + ": template directory expected following -idlpp option");
        throw new CmdException (1);
      }
      templates = arg2;
      result = true;
