...
public class GenSymbolTable extends com.prismtech.lite.parser.IDLBaseVisitor <Void>
{
  ...
  public Void visitWide_char_type (IDLParser.Wide_char_typeContext ctx)
  {
    ...
    {
      bogusType
        ("wide char data not supported in Vortex Lite", ctx.KW_WCHAR ());
    }
  ...
  public Void visitWide_string_type (IDLParser.Wide_string_typeContext ctx)
  {
    ...
    {
      bogusType
        ("wide string data not supported in Vortex Lite", ctx.KW_WSTRING ());
    }
    return super.visitWide_string_type (ctx);
  }

  /* Fixed-point type NYI */

  public Void visitFixed_pt_type (IDLParser.Fixed_pt_typeContext ctx)
  {
    bogusType
      ("fixed point data not supported in Vortex Lite", ctx.KW_FIXED ());
  ...
  public Void visitFloating_pt_type (IDLParser.Floating_pt_typeContext ctx)
  {
    ...
    {
      bogusType
        ("long double data not supported in Vortex Lite", ctx.KW_LONG ());
    }
    if (currentTD != null)
    {
      currentTD.setNonintConst ();
