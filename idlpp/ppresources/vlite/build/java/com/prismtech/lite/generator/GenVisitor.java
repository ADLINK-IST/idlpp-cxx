...
import com.prismtech.lite.*;

public class GenVisitor extends com.prismtech.lite.parser.IDLBaseVisitor <Void>
{
  ...
  public GenVisitor (IdlParams params, String templates)
  {
    ...
    if (params.forcpp)
    {
      file.add ("name", params.basename + "-cyclone");
    }
    else
    {
  ...
  public Void visitSequence_type (IDLParser.Sequence_typeContext ctx)
  {
    ...
    oldstate.type = new SequenceType (state.type, bound);
