...
#ifdef USE_PV_PORT_MALLOC
static void *(* ptr_malloc)(size_t) = &pvPortMalloc;
static void (* ptr_free)(void *) = &vPortFree;
static void *(* ptr_realloc)(void *, size_t) = &os_pvPortRealloc;
#else /* USE_PV_PORT_MALLOC */
static void *(* ptr_malloc)(size_t) = malloc;
static void (* ptr_free)(void *) = free;
static void *(* ptr_realloc)(void *,size_t) = realloc;
#endif /* USE_PV_PORT_MALLOC */
