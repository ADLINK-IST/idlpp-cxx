...
static void convclass_count (c_metaObject object, c_metaWalkActionArg varg)
{
...
static c_bool convclass_convert (c_metaObject object, c_metaWalkActionArg varg)
{
...
static int convclass_body (struct convtype_context *ctx, struct ser_type **rt, unsigned label, const struct c_class_s *cls, os_uint32 srcoff, const struct sd_cdrControl *control)
{
  ...
  c_metaWalk (c_metaObject (cls), convclass_count, &count_arg);
  ...
  c_metaWalkBool (c_metaObject (cls), convclass_convert, &convert_arg);
