...
linkage_ elemT_ prefix_##IterDFirst (const struct prefix_##_s *list, struct prefix_##IterD_s *iter) attrs_; \
linkage_ elemT_ prefix_##IterDNext (struct prefix_##IterD_s *iter) attrs_; \
linkage_ void prefix_##IterDRemove (struct prefix_##_s *list, struct prefix_##IterD_s *iter) attrs_; \
...
{                                                                       \
    ...
    return &iter->node->ary[iter->idx];                                 \
                                                                        ...
                                                                        \
linkage_ elemT_ prefix_##IterDFirst (const struct prefix_##_s *list, struct prefix_##IterD_s *iter) \
{                                                                       \
    iter->node = list->head;                                            \
    iter->prev = NULL;                                                  \
    if (iter->node == NULL) {                                           \
...
{                                                                       \
    ...
    if (iter->idx+1 < iter->node->lastp1) {                             \
        ...
        return iter->node->ary[iter->idx];                              \
                                                                        ...
                                                                        \
linkage_ void prefix_##IterDRemove (struct prefix_##_s *list, struct prefix_##IterD_s *iter) \
{                                                                       \
