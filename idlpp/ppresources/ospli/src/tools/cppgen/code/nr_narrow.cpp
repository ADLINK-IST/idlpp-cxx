/* Copyright (c) Expersoft(R) 1994. All Rights Reserved. */
#ifdef SCCSID
static char SCCSid[] = "@(#)nr_narrow.C 1.2   4/13/95";
#endif
/* Copyright (c) Expersoft(R) 1994. All Rights Reserved. */
#ifdef SCCSID
static char SCCSid[] = "@(#)nr_narrow.C 1.1   9/20/94";
#endif
/*
...
ScopeAsDecl(UTL_Scope *s)
{
   ...
   switch (s->scope_node_type())
   {
         ...
         return AST_Value::narrow_from_scope(s);
