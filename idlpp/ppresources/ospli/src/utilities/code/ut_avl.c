...
static void treedef_init_common (ut_avlTreedef_t *td, os_size_t avlnodeoffset, os_size_t keyoffset, ut_avlCompare_t comparekk, ut_avlCompare_r_t comparekk_r, ut_avlAugment_t augment, os_uint32 flags)
{
...
{
    treedef_init_common (td, avlnodeoffset, keyoffset, comparekk, NULL, augment, flags);
}
...
{
    td->cmp_arg = cmp_arg;
    treedef_init_common (td, avlnodeoffset, keyoffset, NULL, comparekk_r, augment, flags | UT_AVL_TREEDEF_FLAG_R);
}
...
{
    treedef_init_common (&td->t, avlnodeoffset, keyoffset, comparekk, NULL, augment, flags);
}
...
void ut_avlCTreedefInit_r (ut_avlCTreedef_t *td, os_size_t avlnodeoffset, os_size_t keyoffset, ut_avlCompare_r_t comparekk_r, void *cmp_arg, ut_avlAugment_t augment, os_uint32 flags)
{
    ...
    treedef_init_common (&td->t, avlnodeoffset, keyoffset, NULL, comparekk_r, augment, flags | UT_AVL_TREEDEF_FLAG_R);
}
